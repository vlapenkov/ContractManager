...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20210313085011_billparams_added")]
    partial class billparams_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.BillParam", b =>
                {
                    ...
                    b.HasIndex("BillParamTypeId");

                    b.ToTable("BillParams");
                });

            modelBuilder.Entity("Domain.BillParamType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.BillParam", b =>
                {
                    b.HasOne("Domain.BillParamType", "BillParamType")
                        .WithMany()
                        .HasForeignKey("BillParamTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
